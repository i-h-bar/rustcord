...
use crate::adapters::services::spoiler_subscription::init_spoiler_subscription;
...
async fn main() {
    ...
    let sub = init_spoiler_subscription();

    let app = App::new(image_store, card_store, cache, sub);
